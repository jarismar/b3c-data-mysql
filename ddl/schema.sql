...
-- Sun Jun 11 08:21:28 2023
-- Model: B3C MySQL DB    Version: 1.0
...
CREATE TABLE IF NOT EXISTS `b3c`.`company` (
  ...
  `cmp_bdr` BIT(1) NOT NULL,
  `cmp_etf` BIT(1) NOT NULL,
  PRIMARY KEY (`cmp_id`),
...
CREATE TABLE IF NOT EXISTS `b3c`.`trade_batch` (
  ...
  `trb_shr_loss` DOUBLE NOT NULL,
  `trb_bdr_loss` DOUBLE NOT NULL,
  `trb_etf_loss` DOUBLE NOT NULL,
  `trb_shr_results` DOUBLE NOT NULL,
  `trb_bdr_results` DOUBLE NOT NULL,
  `trb_etf_results` DOUBLE NOT NULL,
  `trb_total_shr_trade` DECIMAL(10,2) NOT NULL,
  `trb_total_shr_tax` DOUBLE NOT NULL,
  `trb_total_bdr_tax` DOUBLE NOT NULL,
  `trb_total_etf_tax` DOUBLE NOT NULL,
  PRIMARY KEY (`trb_id`),
  INDEX `IXFK_TRB_TGR` (`tgr_id` ASC) VISIBLE,
  INDEX `IXFK_TRB_USR` (`usr_id` ASC) VISIBLE,
